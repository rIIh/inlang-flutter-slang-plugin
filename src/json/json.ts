...
import type { Message, Variant, LanguageTag, NodeishFilesystemSubset } from "@inlang/sdk"
import { PluginSettings } from "../settings.js"
import { replaceAll } from "./utilities.js"
import { flatten, unflatten } from "flat"
import { detectJsonFormatting } from "./detectJsonFormating.js"
...
const addVariantToMessages = (
	...
	if (messageIndex !== -1) {
		...
		const hasNamespace = key.split(':').length > 1
